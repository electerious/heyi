...
- Default AI model changed from `openai/gpt-4o-mini` to `openai/gpt-5.6-luna`

## [3.1.3] - 2026-07-11

### Changed

- Reduced amount of dependencies by getting rid of `dotenv` in favor of native Node.js functionality
